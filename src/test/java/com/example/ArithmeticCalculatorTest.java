...
class ArithmeticCalculatorTest {
    ...
    void setUp() {
        a = 10;
        b = 5;
        System.out.println("Подготовка данных: a=" + a + ", b=" + b);
    }
    ...
    void testAddition() {
        assertEquals(15, ArithmeticCalculator.add(a, b));
    }

    @Test
    @DisplayName("Вычитание: 10 - 5 = 5")
    void testSubtraction() {
        assertEquals(5, ArithmeticCalculator.subtract(a, b));
    }

    @Test
    @DisplayName("Умножение: 10 * 5 = 50")
    void testMultiplication() {
        assertEquals(50, ArithmeticCalculator.multiply(a, b));
    }

    @Test
    @DisplayName("Деление: 10 / 5 = 2.0")
    void testDivision() {
        assertEquals(2.0, ArithmeticCalculator.divide(a, b));
    }
    ...
    void testNegativeNumbers() {
        assertAll("Отрицательные числа",
                () -> assertEquals(-5, ArithmeticCalculator.add(-10, 5)),
                () -> assertEquals(10, ArithmeticCalculator.subtract(5, -5)),
